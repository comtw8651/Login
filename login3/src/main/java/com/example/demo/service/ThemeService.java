...
public class ThemeService {
    ...
    public Optional<Theme> findByThemeName(String themeName) {
        ...
        try {
            Theme theme = jdbcTemplate.queryForObject(sql, new Object[]{themeName}, new ThemeRowMapper());
    ...
    public Optional<Theme> findById(Long id) {
        ...
        try {
            Theme theme = jdbcTemplate.queryForObject(sql, new Object[]{id}, new ThemeRowMapper());
            return Optional.ofNullable(theme);
        } catch (EmptyResultDataAccessException e) {
            return Optional.empty();
        }
